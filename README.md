...
You can also generate yourself PartNetMobility data following data_generatation/blend.sh.  (PartNet_Mobility <a href="https://huggingface.co/datasets/sapien-sim/PartNetMobility">[Here]</a>)
